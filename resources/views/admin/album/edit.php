    ...
    <form id="album-form" class="form-horizontal" method="post" role="form">
      ...
      <div class="clearfix form-actions form-group">
        <div class="offset-lg-2">
          ...
          &nbsp; &nbsp; &nbsp;
          <a class="btn btn-secondary" href="<?= $url('admin/album/index') ?>">
...
<?= $block->js() ?>
<script>
  require(['plugins/link-to/js/link-to', 'plugins/admin/js/form', 'ueditor', 'plugins/admin/js/image-upload'], function (linkTo, form) {
