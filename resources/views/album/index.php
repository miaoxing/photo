...
<script src="<?= $asset('comps/TouchNSwipe/modernizr.min.js') ?>"></script>
<script src="<?= $asset('comps/TouchNSwipe/jquery.hammer.min.js') ?>"></script>
<script src="<?= $asset('comps/TouchNSwipe/TweenMax.min.js') ?>"></script>
<script src="<?= $asset('comps/TouchNSwipe/TouchNSwipe.js') ?>"></script>
<?= $block->end() ?>
